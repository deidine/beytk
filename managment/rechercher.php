	...
	<div> 	
		<div class="panel-heading">
			<div class="row">
				...
				<div class="row-md-3" align="right">
                
            <button type="button" id="rechercher" class="btn btn-info" title="Add house">rechercher</button>
	<div id="modelRech" class="modal fade">
			<form method="post" id="formRech">
        <input type="text" id="lieu1" name="lieu1" size=30px placeholder="Rechercher..." >
        <input type="hidden" name="action1" id="action1" value="" />
    					<input type="submit" name="save1" id="save1" class="btn btn-info" value="rechercher" />
    </form>   </div>
	</div>
			</div>
		</div>
