...
class Clients {	
	...
	public function insert(){
		...
		if($this->name) {
			...
			$stmt = $this->conn->prepare("INSERT INTO ".$this->clientsTable." (`name`, `prenom`, `description`, `phone`,`address`,numero) VALUES (?,?,?,?,?,?)");
			...
			$stmt->bind_param("sssssi", $this->name, $this->prenom, $this->description, $this->phone, $this->address,$this->numero);
	...
	public function update(){
		...
		if($this->id) {			
			...
			$stmt = $this->conn->prepare("UPDATE pm_clients SET name= ?, prenom = ?, description = ?, phone = ?, address = ?,numero=?	WHERE id = ?");
			$this->name = htmlspecialchars(strip_tags($this->name));
			$this->prenom = htmlspecialchars(strip_tags($this->prenom));
			$this->description = htmlspecialchars(strip_tags($this->description));
			$this->phone = htmlspecialchars(strip_tags($this->phone));
			...
			$this->numero =$this->numero;	
			$this->id=$this->id;
			$stmt->bind_param("sssssii", $this->name, $this->prenom, $this->description, $this->phone, $this->address,$this->numero,$this->id);
