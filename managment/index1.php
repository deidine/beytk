    		...
    		<form method="post" id="clientForm">
    			<div class="modal-content">
					...
					<div class="form-group">
							...
							<input type="number" class="form-control" id="id" name="id" placeholder="Name" readonly>			
						</div>
						<div class="form-group">
							<label for="numero" class="control-label">numero</label>
							<input type="number" class="form-control" id="numero" name="numero" placeholder="Name" >			
						</div>
						<div class="form-group">
